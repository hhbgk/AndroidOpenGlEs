 ...
 * UpdateRemark:
 */
public class AirHockey3Render implements GLSurfaceView.Renderer {
    ...
    public AirHockey3Render(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String vertexShaderSource = TextResourceReader.readTextFileFromResource(context, R.raw.simple_vertex_shader3);
